...
host_server = os.environ.get('host_server', 'database-2-instance-1.cmjupnv93jta.ap-southeast-1.rds.amazonaws.com')
db_server_port = urllib.parse.quote_plus(str(os.environ.get('db_server_port', '5432')))
database_name = os.environ.get('database_name', 'packaters')
db_username = urllib.parse.quote_plus(str(os.environ.get('db_username', 'postgres')))
db_password = urllib.parse.quote_plus(str(os.environ.get('db_password', '53gdygbn')))
